...
certikd add-genesis-account $(certikcli keys show alice -a) 1000000000uctk --vesting-amount 500000000uctk --manual
#certikd add-genesis-account $(certikcli keys show clara -a) 1000000000uctk --vesting-amount 500000000uctk --vesting-start-time 1599011600 --period 500 --num-periods 2 --triggered 
