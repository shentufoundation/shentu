...
func TestAppImportExport(t *testing.T) {
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		{app.GetKey(oracle.StoreKey), newApp.GetKey(oracle.StoreKey), [][]byte{oracle.TaskStoreKeyPrefix, oracle.ClosingTaskStoreKeyPrefix, oracle.ClosingTaskStoreKeyTimedPrefix, oracle.ExpireTaskStoreKeyPrefix, oracle.LeftBountyStoreKeyPrefix}},
