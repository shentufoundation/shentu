...
func TestAppImportExport(t *testing.T) {
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		{app.GetKey(shield.StoreKey), newApp.GetKey(shield.StoreKey), [][]byte{shield.WithdrawQueueKey, shield.PurchaseQueueKey, shield.BlockNativeServiceFeeKey}},
		{app.GetKey(shield.StoreKey), newApp.GetKey(shield.StoreKey), [][]byte{shield.WithdrawQueueKey, shield.PurchaseQueueKey, shield.BlockForeignServiceFeeKey}},
