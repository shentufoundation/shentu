...
Example:
	...
	cmd.Flags().String(flagNodeHome, "shentud", "Home directory of the node's daemon configuration")
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), keyringBackend, appDir, inBuf, clientCtx.Codec)
		if err != nil {
			return err
		}
