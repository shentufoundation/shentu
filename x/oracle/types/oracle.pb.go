...
type Task struct {
	...
	Result        cosmossdk_io_math.Int                    `protobuf:"bytes,9,opt,name=result,proto3,customtype=cosmossdk.io/math.Int" json:"result" yaml:"result"`
...
type Response struct {
	...
	Weight   cosmossdk_io_math.Int                    `protobuf:"bytes,3,opt,name=weight,proto3,customtype=cosmossdk.io/math.Int" json:"weight" yaml:"weight"`
...
type TaskParams struct {
	...
	AggregationResult  cosmossdk_io_math.Int       `protobuf:"bytes,3,opt,name=aggregation_result,json=aggregationResult,proto3,customtype=cosmossdk.io/math.Int" json:"aggregation_result" yaml:"aggregation_result"`
	ThresholdScore     cosmossdk_io_math.Int       `protobuf:"bytes,4,opt,name=threshold_score,json=thresholdScore,proto3,customtype=cosmossdk.io/math.Int" json:"threshold_score" yaml:"threshold_score"`
	Epsilon1           cosmossdk_io_math.Int       `protobuf:"bytes,5,opt,name=epsilon1,proto3,customtype=cosmossdk.io/math.Int" json:"epsilon1" yaml:"epsilon1"`
	Epsilon2           cosmossdk_io_math.Int       `protobuf:"bytes,6,opt,name=epsilon2,proto3,customtype=cosmossdk.io/math.Int" json:"epsilon2" yaml:"epsilon2"`
	ShortcutQuorum     cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=shortcut_quorum,json=shortcutQuorum,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"shortcut_quorum" yaml:"shortcut_quorum"`
}
...
var fileDescriptor_8a60831f9c2fed90 = []byte{
	...
	,
}
...
func (m *TxTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x2a
	n4, err4 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.ValidTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.ValidTime):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
...
func (m *TxTask) Size() (n int) {
	...
	l = github_com_cosmos_gogoproto_types.SizeOfStdTime(m.ValidTime)
	n += 1 + l + sovOracle(uint64(l))
	l = github_com_cosmos_gogoproto_types.SizeOfStdTime(m.Expiration)
	n += 1 + l + sovOracle(uint64(l))
	if len(m.Responses) > 0 {
...
func (m *TxTask) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(&m.ValidTime, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
