...
func (m *AtxTask) Reset()         { *m = AtxTask{} }
func (m *AtxTask) String() string { return proto.CompactTextString(m) }
func (*AtxTask) ProtoMessage()    {}
func (*AtxTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a60831f9c2fed90, []int{9}
}
func (m *AtxTask) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AtxTask) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AtxTask.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AtxTask) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AtxTask.Merge(m, src)
}
func (m *AtxTask) XXX_Size() int {
	return m.Size()
}
func (m *AtxTask) XXX_DiscardUnknown() {
	xxx_messageInfo_AtxTask.DiscardUnknown(m)
}

var xxx_messageInfo_AtxTask proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AtxTask)(nil), "shentu.oracle.v1alpha1.AtxTask")
}
...
var fileDescriptor_8a60831f9c2fed90 = []byte{
	...
	,
...
func (m *AtxTask) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AtxTask) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AtxTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AtxTask) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AtxTask: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AtxTask: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
