...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(MsgCreateAtxTask{}, "oracle/CreateAtxTask", nil)
	cdc.RegisterConcrete(MsgAtxTaskResponse{}, "oracle/RespondToAtxTask", nil)
	cdc.RegisterConcrete(MsgDeleteAtxTask{}, "oracle/DeleteAtxTask", nil)

	cdc.RegisterInterface((*TaskI)(nil), nil)
	cdc.RegisterConcrete(Task{}, "oracle/Task", nil)
	cdc.RegisterConcrete(AtxTask{}, "oracle/AtxTask", nil)
}
...
func RegisterInterfaces(registry types.InterfaceRegistry) {
	...
	registry.RegisterInterface("shentu.oracle.v1alpha1.TaskI", (*TaskI)(nil), &Task{}, &AtxTask{})
