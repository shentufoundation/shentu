...
//		AggregationResult:  math.NewInt(r.Int63n(100)),
//		ThresholdScore:     math.NewInt(r.Int63n(100)),
//		Epsilon1:           math.NewInt(r.Int63n(10) + 1),
//		Epsilon2:           math.NewInt(r.Int63n(10) + 90),
//		ShortcutQuorum:     math.LegacyNewDecWithPrec(int64((r.Float64()+r.Float64())/2*10000)+1, 4),
//	}
//}
