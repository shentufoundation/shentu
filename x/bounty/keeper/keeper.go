...
type Keeper struct {
	...
	CitationRewards     collections.Map[sdk.AccAddress, types.Reward]                            // Rewards key: address | value: Reward
...
func NewKeeper(
	...
	k := Keeper{
		...
		CitationRewards:     collections.NewMap(sb, types.CitationRewardKeyPrefix, "citation_rewards", sdk.AccAddressKey, codec.CollValue[types.Reward](cdc)),
