...
type MsgDeploy struct {
	...
	Is_EWASM bool `protobuf:"varint,6,opt,name=is_EWASM,json=isEWASM,proto3" json:"is_EWASM,omitempty" yaml:"is_EWASM"`
...
func (m *MsgDeploy) GetIs_EWASM() bool {
	if m != nil {
		return m.Is_EWASM
	}
	return false
...
type MsgView struct {
	Caller string `protobuf:"bytes,1,opt,name=caller,proto3" json:"caller,omitempty" yaml:"caller"`
	Callee string `protobuf:"bytes,2,opt,name=callee,proto3" json:"callee,omitempty" yaml:"callee"`
	Data   string `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty" yaml:"data"`
}
...
var fileDescriptor_83f9b3577718d7e8 = []byte{
	...
	,
}
...
func (m *MsgDeploy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Is_EWASM", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
