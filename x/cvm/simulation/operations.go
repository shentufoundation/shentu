...
func WeightedOperations(appParams sim.AppParams, cdc codec.JSONMarshaler, k keeper.Keeper) simulation.WeightedOperations {
...
func SimulateMsgDeployHello55(k keeper.Keeper) sim.Operation {
...
func SimulateMsgDeploySimple(k keeper.Keeper) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallSimpleSet(k keeper.Keeper, contractAddr sdk.AccAddress, varValue int) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgDeploySimpleEvent(k keeper.Keeper) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallSimpleEventSet(k keeper.Keeper, contractAddr sdk.AccAddress, varValue int) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgDeployStorage(k keeper.Keeper) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStorageStore(k keeper.Keeper, contractAddr sdk.AccAddress, varValue int) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgDeployStringTest(k keeper.Keeper) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStringTestChangeString(k keeper.Keeper, contractAddr sdk.AccAddress, ref *string) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStringTestChangeGiven(k keeper.Keeper, contractAddr sdk.AccAddress) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStringTestGets(k keeper.Keeper, contractAddr sdk.AccAddress, ref *string) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStringTestGetl(k keeper.Keeper, contractAddr sdk.AccAddress, ref *string) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
...
func SimulateMsgCallStringTestTestStuff(k keeper.Keeper, contractAddr sdk.AccAddress) sim.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []sim.Account, chainID string) (
		sim.OperationMsg, []sim.FutureOperation, error) {
		caller, _ := sim.RandomAcc(r, accs)
