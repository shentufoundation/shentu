...
//nolint:interfacer
func NewMsgSubmitProposal(content govtypes.Content, initialDeposit sdk.Coins, proposer sdk.AccAddress) (*MsgSubmitProposal, error) {
	m := &MsgSubmitProposal{
...
func (m MsgSubmitProposal) Route() string { return govtypes.RouterKey }
...
// Route implements Msg
func (msg MsgDeposit) Route() string { return govtypes.RouterKey }
...
// Route implements Msg
func (msg MsgVote) Route() string { return govtypes.RouterKey }
