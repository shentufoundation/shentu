...
//			lossAmountDec := sdk.NewDecFromInt(c.Loss.AmountOf(denom))
//			claimProposalParams := k.ShieldKeeper.GetClaimProposalParams(ctx)
//			depositRate := claimProposalParams.DepositRate
//			minDepositAmountDec := sdk.MaxDec(sdk.NewDecFromInt(claimProposalParams.MinDeposit.AmountOf(denom)), lossAmountDec.Mul(depositRate))
