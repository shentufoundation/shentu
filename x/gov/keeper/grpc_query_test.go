...
func (suite *KeeperTestSuite) TestQueryProposals() {
	...
	events := []struct {
		...
		},
		{
			...
			fundedCoins:   sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (700)*1e6)),
			depositAmount: sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (100)*1e6)),
		},
		{
			proposal: proposal{
			...
			deposit:       true,
			depositor:     suite.address[0],
			fundedCoins:   sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (500)*1e6)),
			depositAmount: sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (500)*1e6)),
		},
		{
			proposal: proposal{
			...
			depositor:     suite.address[0],
			fundedCoins:   sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (700)*1e6)),
			depositAmount: sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (700)*1e6)),
		},
		{
			proposal: proposal{
				// StatusValidatorVotingPeriod 3
...
func (suite *KeeperTestSuite) TestQueryDeposits() {
	...
	events := []struct {
	...
	}{
		{
			...
			fundedCoins:   sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (250)*1e6)),
			depositAmount: sdk.NewCoins(sdk.NewInt64Coin(suite.denom, (250)*1e6)),
		},
		{
			proposal: proposal{
				title:       "title1",
