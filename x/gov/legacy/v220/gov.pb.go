...
// https://github.com/shentufoundation/shentu/blob/v2.2.0/x/gov/types/gov.pb.go
// nolint
...
const (
	// StatusNil defines the default propopsal status.
	StatusNil ProposalStatus = 0
	// StatusDepositPeriod defines a proposal status during the deposit
	// period.
	StatusDepositPeriod ProposalStatus = 1
	// StatusCertifierVotingPeriod defines a certifier voting period status.
	StatusCertifierVotingPeriod ProposalStatus = 2
	// StatusValidatorVotingPeriod defines a validator voting period status.
	StatusValidatorVotingPeriod ProposalStatus = 3
	// StatusPassed defines a proposal status of a proposal that has
	// passed.
	StatusPassed ProposalStatus = 4
	// StatusRejected defines a proposal status of a proposal that has
	// been rejected.
	StatusRejected ProposalStatus = 5
	// StatusFailed defines a proposal status of a proposal that has
	// failed.
