...
type GenesisState struct {
	...
	NftAdmin    []NFTAdmin         `protobuf:"bytes,2,rep,name=nft_admin,json=nftAdmin,proto3" json:"nft_admin"`
}
...
func (m *GenesisState) GetNftAdmin() []NFTAdmin {
	if m != nil {
		return m.NftAdmin
	}
	return nil
...
var fileDescriptor_0818b3d7a68899ff = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.NftAdmin) > 0 {
		for iNdEx := len(m.NftAdmin) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NftAdmin[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NftAdmin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NftAdmin = append(m.NftAdmin, NFTAdmin{})
			if err := m.NftAdmin[len(m.NftAdmin)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
