...
var (
	...
	pattern_Query_Admin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"irismod", "nft", "admins", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Admins_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"irismod", "nft", "admins"}, "", runtime.AssumeColonVerbOpt(true)))
)
