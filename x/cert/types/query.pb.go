...
type QueryCertificateResponse struct {
	...
	CompilationContent []KVPair `protobuf:"bytes,4,rep,name=compilation_content,json=compilationContent,proto3" json:"compilation_content"`
...
func (m *QueryCertificateResponse) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
func (m *QueryCertificateResponse) GetCompilationContent() []KVPair {
	if m != nil {
		return m.CompilationContent
	}
	return nil
}
...
var fileDescriptor_d0446c22ac299371 = []byte{
	...
	,
}
...
func (m *QueryCertificateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CompilationContent) > 0 {
		for iNdEx := len(m.CompilationContent) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CompilationContent[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryCertificateResponse) Size() (n int) {
	...
	if len(m.CompilationContent) > 0 {
		for _, e := range m.CompilationContent {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryCertificateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.CompilationContent = append(m.CompilationContent, KVPair{})
			if err := m.CompilationContent[len(m.CompilationContent)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
