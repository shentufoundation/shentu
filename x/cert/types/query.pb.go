...
type QueryCertificateResponse struct {
	...
	Content            []KVPair `protobuf:"bytes,3,rep,name=content,proto3" json:"content"`
...
func (m *QueryCertificateResponse) GetContent() []KVPair {
	if m != nil {
		return m.Content
	}
	return nil
...
var fileDescriptor_d0446c22ac299371 = []byte{
	...
	,
}
...
func (m *QueryCertificateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Content = append(m.Content, KVPair{})
