...
func NewQuerier(keeper Keeper) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) (res []byte, err error) {
		...
		case types.QueryCertifier:
			return queryCertifier(ctx, path[1:], keeper)
		case types.QueryCertifiers:
			return queryCertifiers(ctx, path[1:], keeper)
		case types.QueryCertifierByAlias:
			return queryCertifierByAlias(ctx, path[1:], keeper)
		case types.QueryCertifiedValidator:
			return queryCertifiedValidator(ctx, path[1:], keeper)
		case types.QueryCertifiedValidators:
			return queryCertifiedValidators(ctx, path[1:], keeper)
		case types.QueryPlatform:
			return queryPlatform(ctx, path[1:], keeper)
		case types.QueryCertificate:
			return queryCertificate(ctx, path[1:], keeper)
		case types.QueryCertificates:
			return queryCertificates(ctx, path[1:], req, keeper)
		default:
...
func queryCertifier(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	...
	res, err = codec.MarshalJSONIndent(keeper.cdc, certifier)
	if err != nil {
...
func queryCertifiers(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	err = validatePathLength(path, 0)
	if err != nil {
		return nil, err
	}
	res, err = codec.MarshalJSONIndent(keeper.cdc, types.QueryResCertifiers{Certifiers: keeper.GetAllCertifiers(ctx)})
	if err != nil {
		return nil, sdkerrors.Wrap(sdkerrors.ErrJSONMarshal, err.Error())
	}
	return res, nil
...
func queryCertifierByAlias(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	if err := validatePathLength(path, 1); err != nil {
		return nil, err
	}
...
func queryCertifiedValidator(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	if err := validatePathLength(path, 1); err != nil {
		return nil, err
	}
	...
	res, err = codec.MarshalJSONIndent(keeper.cdc, types.QueryResValidator{Certifier: certifier})
	if err != nil {
		return nil, sdkerrors.Wrap(sdkerrors.ErrJSONMarshal, err.Error())
	}
	return res, nil
...
func queryCertifiedValidators(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	err = validatePathLength(path, 0)
	if err != nil {
		return nil, err
	}
	res, err = codec.MarshalJSONIndent(keeper.cdc, types.QueryResValidators{Validators: keeper.GetAllValidatorPubkeys(ctx)})
	if err != nil {
		return nil, sdkerrors.Wrap(sdkerrors.ErrJSONMarshal, err.Error())
	}
	return res, nil
...
func queryPlatform(ctx sdk.Context, path []string, keeper Keeper) (res []byte, err error) {
	if len(path) != 1 {
	...
	res, err2 := codec.MarshalJSONIndent(keeper.cdc, types.QueryResPlatform{Platform: platform})
	if err2 != nil {
