...
type QueryShieldStatusResponse struct {
	...
	CurrentFees             github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,4,rep,name=current_fees,json=currentFees,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"current_fees"`
	RemainingFees           github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,5,rep,name=remaining_fees,json=remainingFees,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"remaining_fees"`
...
func (m *QueryShieldStatusResponse) GetCurrentFees() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
...
func (m *QueryShieldStatusResponse) GetRemainingFees() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.RemainingFees
	}
	return nil
}
...
var fileDescriptor_1cb9aa5f07f44644 = []byte{
	...
	,
}
...
func (m *QueryShieldStatusResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x32
	if len(m.RemainingFees) > 0 {
		for iNdEx := len(m.RemainingFees) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RemainingFees[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.CurrentFees) > 0 {
		for iNdEx := len(m.CurrentFees) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CurrentFees[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryShieldStatusResponse) Size() (n int) {
	...
	n += 1 + l + sovQuery(uint64(l))
	if len(m.CurrentFees) > 0 {
		for _, e := range m.CurrentFees {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
	if len(m.RemainingFees) > 0 {
		for _, e := range m.RemainingFees {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryShieldStatusResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.CurrentFees = append(m.CurrentFees, types.DecCoin{})
			if err := m.CurrentFees[len(m.CurrentFees)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemainingFees", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RemainingFees = append(m.RemainingFees, types.DecCoin{})
			if err := m.RemainingFees[len(m.RemainingFees)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
