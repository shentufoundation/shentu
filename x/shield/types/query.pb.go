...
type QueryShieldStatusResponse struct {
	...
	NativeCurrentServiceFee    NativeDecCoin                          `protobuf:"bytes,4,opt,name=native_current_service_fee,json=nativeCurrentServiceFee,proto3" json:"native_current_service_fee" yaml:"native_current_service_fee"`
	ForeignCurrentServiceFee   ForeignDecCoin                         `protobuf:"bytes,5,opt,name=foreign_current_service_fee,json=foreignCurrentServiceFee,proto3" json:"foreign_current_service_fee" yaml:"foreign_current_service_fee"`
	NativeRemainingServiceFee  NativeDecCoin                          `protobuf:"bytes,6,opt,name=native_remaining_service_fee,json=nativeRemainingServiceFee,proto3" json:"native_remaining_service_fee" yaml:"native_remaining_service_fee"`
	ForeignRemainingServiceFee ForeignDecCoin                         `protobuf:"bytes,7,opt,name=foreign_remaining_service_fee,json=foreignRemainingServiceFee,proto3" json:"foreign_remaining_service_fee" yaml:"foreign_remaining_service_fee"`
...
func (m *QueryShieldStatusResponse) GetNativeCurrentServiceFee() NativeDecCoin {
	if m != nil {
		return m.NativeCurrentServiceFee
	}
	return NativeDecCoin{}
}

func (m *QueryShieldStatusResponse) GetForeignCurrentServiceFee() ForeignDecCoin {
	if m != nil {
		return m.ForeignCurrentServiceFee
	}
	return ForeignDecCoin{}
}

func (m *QueryShieldStatusResponse) GetNativeRemainingServiceFee() NativeDecCoin {
	if m != nil {
...
func (m *QueryShieldStatusResponse) GetForeignRemainingServiceFee() ForeignDecCoin {
	if m != nil {
...
var fileDescriptor_1cb9aa5f07f44644 = []byte{
	...
	,
}
...
func (m *QueryShieldStatusResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x32
	{
		size, err := m.ForeignCurrentServiceFee.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x2a
	{
		size, err := m.NativeCurrentServiceFee.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryShieldStatusResponse) Size() (n int) {
	...
	n += 1 + l + sovQuery(uint64(l))
	l = m.NativeCurrentServiceFee.Size()
	n += 1 + l + sovQuery(uint64(l))
	l = m.ForeignCurrentServiceFee.Size()
	n += 1 + l + sovQuery(uint64(l))
...
func (m *QueryShieldStatusResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.NativeCurrentServiceFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			if err := m.ForeignCurrentServiceFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
