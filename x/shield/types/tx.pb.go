...
type MsgCreatePool struct {
	...
	NativeDeposit  NativeCoin                               `protobuf:"bytes,3,opt,name=native_deposit,json=nativeDeposit,proto3" json:"native_deposit" yaml:"native_deposit"`
	ForeignDeposit ForeignCoin                              `protobuf:"bytes,4,opt,name=foreign_deposit,json=foreignDeposit,proto3" json:"foreign_deposit" yaml:"foreign_deposit"`
...
type MsgUpdatePool struct {
	From              string                                   `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty" yaml:"from"`
	Shield            github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=shield,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"shield"`
	NativeServiceFee  NativeCoin                               `protobuf:"bytes,3,opt,name=native_service_fee,json=nativeServiceFee,proto3" json:"native_service_fee" yaml:"native_service_fees"`
	ForeignServiceFee ForeignCoin                              `protobuf:"bytes,4,opt,name=foreign_service_fee,json=foreignServiceFee,proto3" json:"foreign_service_fee" yaml:"foreign_service_fees"`
...
var fileDescriptor_e048a9056d0d0343 = []byte{
	...
	,
}
...
func (m *MsgCreatePool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.ForeignDeposit.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x22
	{
		size, err := m.NativeDeposit.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgCreatePool) Size() (n int) {
	...
	l = m.NativeDeposit.Size()
	n += 1 + l + sovTx(uint64(l))
	l = m.ForeignDeposit.Size()
	n += 1 + l + sovTx(uint64(l))
	l = len(m.Sponsor)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
...
func (m *MsgCreatePool) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.NativeDeposit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			if err := m.ForeignDeposit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
