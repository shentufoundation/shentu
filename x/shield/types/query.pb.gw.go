...
var (
	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 5}, []string{"shentu", "shield", "v1alpha1", "pool", "pool_id", "sponsor"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_Query_PurchaseList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"shentu", "shield", "v1alpha1", "pool", "pool_id", "purchaser", "purchase_list"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PurchaseLists_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"shentu", "shield", "v1alpha1", "pool", "pool_id", "purchaser", "purchase_lists"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_Query_ShieldStaking_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"shentu", "shield", "v1alpha1", "pool", "pool_id", "purchaser", "shield_staking"}, "", runtime.AssumeColonVerbOpt(true)))
