...
var (
	...
	pattern_Query_Donations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shentu", "shield", "v1alpha1", "donations"}, "", runtime.AssumeColonVerbOpt(true)))
)
