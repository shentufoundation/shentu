...
func ParamKeyTable() paramtypes.KeyTable {
	return paramtypes.NewKeyTable(
		...
		paramtypes.NewParamSetPair(v1alpha1.ParamStoreKeyClaimProposalParams, v1alpha1.ClaimProposalParams{}, v1alpha1.ValidateClaimProposalParams),
		paramtypes.NewParamSetPair(v1alpha1.ParamStoreKeyStakingShieldRate, sdk.Dec{}, v1alpha1.ValidateStakingShieldRateParams),
