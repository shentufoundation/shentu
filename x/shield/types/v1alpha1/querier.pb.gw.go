...
var (
	...
	pattern_Query_DistrParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shentu", "shield", "v1alpha1", "distr_params"}, "", runtime.AssumeColonVerbOpt(true)))
