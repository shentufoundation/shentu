...
func (sh *Helper) CreatePool(addr, sponsorAddr sdk.AccAddress, description string, shieldRate sdk.Dec, shieldLimit sdk.Coins) {
	msg := types.NewMsgCreatePool(addr, sponsorAddr, description, shieldRate, shieldLimit)
	sh.Handle(msg, true)
}
