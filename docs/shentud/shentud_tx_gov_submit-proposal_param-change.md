## shentud tx gov submit-proposal param-change
...
Example:
$ shentud tx gov submit-proposal param-change <path/to/proposal.json> --from=<key_or_address>
...
```
shentud tx gov submit-proposal param-change [proposal-file] [flags]
```
