## shentud query ibc channel unreceived-acks
...
```
shentud query ibc channel unreceived-acks [port-id] [channel-id] [flags]
```

### Examples

```
shentud query ibc channel unreceived-acks [port-id] [channel-id] --sequences=1,2,3
```
