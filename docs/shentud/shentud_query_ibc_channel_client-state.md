## shentud query ibc channel client-state
...
```
shentud query ibc channel client-state [port-id] [channel-id] [flags]
```

### Examples

```
shentud query ibc channel client-state [port-id] [channel-id]
```
