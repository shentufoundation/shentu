## certik query staking unbonding-delegations-from
...
Example:
$ <appd> query staking unbonding-delegations-from certikvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
certik query staking unbonding-delegations-from [validator-addr] [flags]
```
