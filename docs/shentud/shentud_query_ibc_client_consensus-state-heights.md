## shentud query ibc client consensus-state-heights
...
```
shentud query ibc client consensus-state-heights [client-id] [flags]
```

### Examples

```
shentud query ibc client consensus-state-heights [client-id]
```
