## shentud tx ibc-transfer transfer
...
```
shentud tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount] [flags]
```

### Examples

```
shentud tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount]
```
