## certikcli tx distribution withdraw-all-rewards
...
Example:
$ certikcli tx distribution withdraw-all-rewards --from mykey

```
certikcli tx distribution withdraw-all-rewards [flags]
```
