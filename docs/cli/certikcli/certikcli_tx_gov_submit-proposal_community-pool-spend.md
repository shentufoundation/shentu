## certikcli tx gov submit-proposal community-pool-spend
...
Example:
$ certikcli tx gov submit-proposal community-pool-spend <path/to/proposal.json> --from=<key_or_address>
...
```
certikcli tx gov submit-proposal community-pool-spend [proposal-file] [flags]
```
