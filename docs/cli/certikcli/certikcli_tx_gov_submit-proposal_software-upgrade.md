## certikcli tx gov submit-proposal software-upgrade
...
```
certikcli tx gov submit-proposal software-upgrade [name] (--upgrade-height [height] | --upgrade-time [time]) (--upgrade-info [info]) [flags]
```
