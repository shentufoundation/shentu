## certikcli tx gov submit-proposal param-change
...
Example:
$ certikcli tx gov submit-proposal param-change <path/to/proposal.json> --from=<key_or_address>
...
```
certikcli tx gov submit-proposal param-change [proposal-file] [flags]
```
